...
class TauSelector(ObjectSelector):
    ...
    def evalTau(self, tau):
        ...
        if tau.idDeepTau2017v2p1VSe<1 and tau.idDeepTau2018v2p5VSe<1: return False # VVVLoose
        if tau.idDeepTau2017v2p1VSmu<1 and tau.idDeepTau2018v2p5VSmu<1: return False # VLoose
        if tau.idDeepTau2017v2p1VSjet<1 and tau.idDeepTau2018v2p5VSjet<1: return False # VVVLoose
